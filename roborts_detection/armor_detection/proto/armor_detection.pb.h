...
class ArmorDetectionAlgorithms : public ::google::protobuf::Message {
 public:
  ...
  // optional uint32 remain_bullets = 7;
  inline bool has_remain_bullets() const;
  inline void clear_remain_bullets();
  static const int kRemainBulletsFieldNumber = 7;
  inline ::google::protobuf::uint32 remain_bullets() const;
  inline void set_remain_bullets(::google::protobuf::uint32 value);

  // required float xgma = 8;
  inline bool has_xgma() const;
  inline void clear_xgma();
  static const int kXgmaFieldNumber = 8;
  inline float xgma() const;
  inline void set_xgma(float value);
 ...
 private:
  ...
  inline void set_has_remain_bullets();
  inline void clear_has_remain_bullets();
  inline void set_has_xgma();
  inline void clear_has_xgma();
  ...
  ::google::protobuf::uint32 remain_bullets_;
...
// optional uint32 remain_bullets = 7;
inline bool ArmorDetectionAlgorithms::has_remain_bullets() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void ArmorDetectionAlgorithms::set_has_remain_bullets() {
  _has_bits_[0] |= 0x00000040u;
}
inline void ArmorDetectionAlgorithms::clear_has_remain_bullets() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void ArmorDetectionAlgorithms::clear_remain_bullets() {
  remain_bullets_ = 0u;
  clear_has_remain_bullets();
}
inline ::google::protobuf::uint32 ArmorDetectionAlgorithms::remain_bullets() const {
  // @@protoc_insertion_point(field_get:roborts_detection.ArmorDetectionAlgorithms.remain_bullets)
  return remain_bullets_;
}
inline void ArmorDetectionAlgorithms::set_remain_bullets(::google::protobuf::uint32 value) {
  set_has_remain_bullets();
  remain_bullets_ = value;
  // @@protoc_insertion_point(field_set:roborts_detection.ArmorDetectionAlgorithms.remain_bullets)
}

// required float xgma = 8;
inline bool ArmorDetectionAlgorithms::has_xgma() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void ArmorDetectionAlgorithms::set_has_xgma() {
  _has_bits_[0] |= 0x00000080u;
}
inline void ArmorDetectionAlgorithms::clear_has_xgma() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void ArmorDetectionAlgorithms::clear_xgma() {
  xgma_ = 0;
  clear_has_xgma();
}
inline float ArmorDetectionAlgorithms::xgma() const {
  // @@protoc_insertion_point(field_get:roborts_detection.ArmorDetectionAlgorithms.xgma)
  return xgma_;
}
inline void ArmorDetectionAlgorithms::set_xgma(float value) {
  set_has_xgma();
  xgma_ = value;
  // @@protoc_insertion_point(field_set:roborts_detection.ArmorDetectionAlgorithms.xgma)
}

// required float k = 9;
inline bool ArmorDetectionAlgorithms::has_k() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void ArmorDetectionAlgorithms::set_has_k() {
  _has_bits_[0] |= 0x00000100u;
}
inline void ArmorDetectionAlgorithms::clear_has_k() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void ArmorDetectionAlgorithms::clear_k() {
  k_ = 0;
  clear_has_k();
}
inline float ArmorDetectionAlgorithms::k() const {
  // @@protoc_insertion_point(field_get:roborts_detection.ArmorDetectionAlgorithms.k)
  return k_;
}
inline void ArmorDetectionAlgorithms::set_k(float value) {
  set_has_k();
  k_ = value;
  // @@protoc_insertion_point(field_set:roborts_detection.ArmorDetectionAlgorithms.k)
}
