...
void protobuf_AssignDesc_armor_5fdetection_2eproto() {
  ...
  static const int ArmorDetectionAlgorithms_offsets_[9] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ArmorDetectionAlgorithms, remain_bullets_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ArmorDetectionAlgorithms, xgma_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ArmorDetectionAlgorithms, k_),
  };
...
void protobuf_AddDesc_armor_5fdetection_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "(\002\022\016\n\006init_k\030\002 \001(\002\"\274\002\n\030ArmorDetectionAlg"
    ...
    "odelInfo\022\026\n\016remain_bullets\030\007 \001(\r\022\014\n\004xgma"
    "\030\010 \002(\002\022\t\n\001k\030\t \002(\002", 537);
...
const int ArmorDetectionAlgorithms::kRemainBulletsFieldNumber;
const int ArmorDetectionAlgorithms::kXgmaFieldNumber;
const int ArmorDetectionAlgorithms::kKFieldNumber;
#endif  // !_MSC_VER
...
#define ZR_(first, last) do {                              \
  ...
  if (_has_bits_[0 / 32] & 254) {
    ZR_(undetected_armor_delay_, remain_bullets_);
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 6: {
        ...
        if (input->ExpectTag(56)) goto parse_remain_bullets;
        break;
      }
      ...
      case 7: {
        if (tag == 56) {
         parse_remain_bullets:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   ::google::protobuf::uint32, ::google::protobuf::internal::WireFormatLite::TYPE_UINT32>(
                 input, &remain_bullets_)));
          set_has_remain_bullets();
        } else {
          goto handle_unusual;
        }
        if (input->ExpectTag(69)) goto parse_xgma;
        break;
      }
      ...
      case 8: {
        ...
        if (input->ExpectTag(77)) goto parse_k;
        break;
      }
...
void ArmorDetectionAlgorithms::SerializeWithCachedSizes(
  ...
  // optional uint32 remain_bullets = 7;
  if (has_remain_bullets()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(7, this->remain_bullets(), output);
  }

  // required float xgma = 8;
  if (has_xgma()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(8, this->xgma(), output);
  }

  // required float k = 9;
  if (has_k()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(9, this->k(), output);
  }
...
::google::protobuf::uint8* ArmorDetectionAlgorithms::SerializeWithCachedSizesToArray(
  ...
  // optional uint32 remain_bullets = 7;
  if (has_remain_bullets()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(7, this->remain_bullets(), target);
  }

  // required float xgma = 8;
  if (has_xgma()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(8, this->xgma(), target);
  }

  // required float k = 9;
  if (has_k()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(9, this->k(), target);
  }
...
void ArmorDetectionAlgorithms::MergeFrom(const ArmorDetectionAlgorithms& from) {
  ...
  if (from._has_bits_[1 / 32] & (0xffu << (1 % 32))) {
    ...
    if (from.has_remain_bullets()) {
      set_remain_bullets(from.remain_bullets());
    }
    if (from.has_xgma()) {
      set_xgma(from.xgma());
    }
...
void ArmorDetectionAlgorithms::Swap(ArmorDetectionAlgorithms* other) {
  if (other != this) {
    ...
    std::swap(remain_bullets_, other->remain_bullets_);
    std::swap(xgma_, other->xgma_);
